...
# -*- coding: utf-8 -*-
"""
Created on Tue May 28 14:17:33 2024
...
F1 = open('C:/Users/MEaTh/OneDrive/Desktop/Semesterarbeit/28.05/2ml D2O, 1ml Agar 1%, 70%, 750nm, 15C.txt','r')
lines1 = F1.readlines()
F1.close()

F2 = open('C:/Users/MEaTh/OneDrive/Desktop/Semesterarbeit/28.05/2ml D2O, 1ml Agar 1%, 70%, 750nm, 25C.txt','r')
lines2 = F2.readlines()
F2.close()

F3 = open('C:/Users/MEaTh/OneDrive/Desktop/Semesterarbeit/28.05/2ml D2O, 1ml Agar 1%, 70%, 750nm, 30C.txt','r')
lines3 = F3.readlines()
F3.close()

F4 = open('C:/Users/MEaTh/OneDrive/Desktop/Semesterarbeit/28.05/2ml D2O, 1ml Agar 1%, 70%, 750nm, 35C.txt','r')
lines4 = F4.readlines()
F4.close()

F5 = open('C:/Users/MEaTh/OneDrive/Desktop/Semesterarbeit/28.05/2ml D2O, 1ml Agar 1%, 70%, 750nm, 40C.txt','r')
lines5 = F5.readlines()
F5.close()

F6 = open('C:/Users/MEaTh/OneDrive/Desktop/Semesterarbeit/28.05/2ml D2O, 1ml Agar 1%, 70%, 750nm, 50C.txt','r')
lines6 = F6.readlines()
F6.close()

F7 = open('C:/Users/MEaTh/OneDrive/Desktop/Semesterarbeit/28.05/2ml D2O, 1ml Agar 1%, 70%, 750nm, 60C.txt','r')
lines7 = F7.readlines()
F7.close()
