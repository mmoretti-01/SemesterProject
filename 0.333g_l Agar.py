...
# -*- coding: utf-8 -*-
"""
Created on Wed May 29 16:07:14 2024
...
F1 = open('C:/Users/MEaTh/OneDrive/Desktop/Semesterarbeit/29.05/2mg nano, 4ml D2O, 2ml Agar 1%, 70%, 750nm, 15C.txt','r')
lines1 = F1.readlines()
F1.close()

F2 = open('C:/Users/MEaTh/OneDrive/Desktop/Semesterarbeit/29.05/2mg nano, 4ml D2O, 2ml Agar 1%, 70%, 750nm, 25C.txt','r')
lines2 = F2.readlines()
F2.close()

F3 = open('C:/Users/MEaTh/OneDrive/Desktop/Semesterarbeit/29.05/2mg nano, 4ml D2O, 2ml Agar 1%, 70%, 750nm, 30C.txt','r')
lines3 = F3.readlines()
F3.close()

F4 = open('C:/Users/MEaTh/OneDrive/Desktop/Semesterarbeit/29.05/2mg nano, 4ml D2O, 2ml Agar 1%, 70%, 750nm, 35C.txt','r')
lines4 = F4.readlines()
F4.close()

F5 = open('C:/Users/MEaTh/OneDrive/Desktop/Semesterarbeit/29.05/2mg nano, 4ml D2O, 2ml Agar 1%, 70%, 750nm, 40C.txt','r')
lines5 = F5.readlines()
F5.close()

F6 = open('C:/Users/MEaTh/OneDrive/Desktop/Semesterarbeit/29.05/2mg nano, 4ml D2O, 2ml Agar 1%, 70%, 750nm, 50C.txt','r')
lines6 = F6.readlines()
F6.close()

F7 = open('C:/Users/MEaTh/OneDrive/Desktop/Semesterarbeit/29.05/2mg nano, 4ml D2O, 2ml Agar 1%, 70%, 750nm, 60C.txt','r')
lines7 = F7.readlines()
F7.close()
...
plt.plot(data[:,0,0],data[:,1,0],label='15C', color = 'darkblue')
...
plt.plot(data[:,0,6],data[:,1,6],label='60C', color = 'darkred')
plt.grid()
...
plt.plot(T,np.polyval(p4,T),linestyle ='--', label='linear fit')
plt.grid()
plt.xlabel('Temperature in \u00b0C')
plt.ylabel('Peak Ratios')
...
plt.plot(T,dFIR_R(T,p4), label = 'linear fit', linestyle ='--')
plt.grid()
plt.xlabel('Temperature in \u00b0C')
plt.ylabel('Relative Sensitivity')
plt.title('Temperature dependence of the relative sensitivity')
