...
# -*- coding: utf-8 -*-
"""
Created on Fri Apr  5 18:38:58 2024
...
F1 = open('/Users/main/Desktop/Semesterarbeit/19.03/15%/15%, 70%, 750nm, 2nd, 15C, up.txt','r')
lines1 = F1.readlines()
F1.close()


F2 = open('/Users/main/Desktop/Semesterarbeit/19.03/15%/15%, 70%, 750nm, 2nd, 30C, up.txt','r')
lines2 = F2.readlines()
F2.close()

F3 = open('/Users/main/Desktop/Semesterarbeit/19.03/15%/15%, 70%, 750nm, 2nd, 45C, up.txt','r')
lines3 = F3.readlines()
F3.close()

F4 = open('/Users/main/Desktop/Semesterarbeit/19.03/15%/15%, 70%, 750nm, 2nd, 60C, up.txt','r')
lines4 = F4.readlines()
F4.close()

F5 = open('/Users/main/Desktop/Semesterarbeit/19.03/15%/15%, 70%, 750nm, 2nd, 15C, down.txt','r')
lines5 = F5.readlines()
F5.close()

F6 = open('/Users/main/Desktop/Semesterarbeit/19.03/15%/15%, 70%, 750nm, 2nd, 30C, down.txt','r')
lines6 = F6.readlines()
F6.close()

F7 = open('/Users/main/Desktop/Semesterarbeit/19.03/15%/15%, 70%, 750nm, 2nd, 45C, down.txt','r')
lines7 = F7.readlines()
F7.close()

F8 = open('/Users/main/Desktop/Semesterarbeit/19.03/15%/15%, 70%, 750nm, 2nd, 60C, down.txt','r')
lines8 = F8.readlines()
F8.close()

F9 = open('/Users/main/Desktop/Semesterarbeit/05.04/10%/10% Er, 70%, 750nm, 15C, up.txt','r')
lines9 = F9.readlines()
F9.close()

F10 = open('/Users/main/Desktop/Semesterarbeit/05.04/10%/10% Er, 70%, 750nm, 30C, up.txt','r')
lines10 = F10.readlines()
F10.close()

F11 = open('/Users/main/Desktop/Semesterarbeit/05.04/10%/10% Er, 70%, 750nm, 45C, up.txt','r')
lines11 = F11.readlines()
F11.close()

F12 = open('/Users/main/Desktop/Semesterarbeit/05.04/10%/10% Er, 70%, 750nm, 60C, up.txt','r')
lines12 = F12.readlines()
F12.close()

F13 = open('/Users/main/Desktop/Semesterarbeit/05.04/10%/10% Er, 70%, 750nm, 15C, down.txt','r')
lines13 = F13.readlines()
F13.close()

F14 = open('/Users/main/Desktop/Semesterarbeit/05.04/10%/10% Er, 70%, 750nm, 30C, down.txt','r')
lines14 = F14.readlines()
F14.close()

F15 = open('/Users/main/Desktop/Semesterarbeit/05.04/10%/10% Er, 70%, 750nm, 45C, down.txt','r')
lines15 = F15.readlines()
F15.close()

F16 = open('/Users/main/Desktop/Semesterarbeit/05.04/10%/10% Er, 70%, 750nm, 60C, down.txt','r')
lines16 = F16.readlines()
F16.close()

F17 = open('/Users/main/Desktop/Semesterarbeit/20.03/5%/5%, 70%, 750nm, 2nd, 15C, up.txt','r')
lines17 = F17.readlines()
F17.close()

F18 = open('/Users/main/Desktop/Semesterarbeit/20.03/5%/5%, 70%, 750nm, 2nd, 30C, up.txt','r')
lines18 = F18.readlines()
F18.close()

F19 = open('/Users/main/Desktop/Semesterarbeit/20.03/5%/5%, 70%, 750nm, 2nd, 45C, up.txt','r')
lines19 = F19.readlines()
F19.close()

F20 = open('/Users/main/Desktop/Semesterarbeit/20.03/5%/5%, 70%, 750nm, 2nd, 60C, up.txt','r')
lines20 = F20.readlines()
F20.close()

F21 = open('/Users/main/Desktop/Semesterarbeit/20.03/5%/5%, 70%, 750nm, 2nd, 15C, down.txt','r')
lines21 = F21.readlines()
F21.close()

F22 = open('/Users/main/Desktop/Semesterarbeit/20.03/5%/5%, 70%, 750nm, 2nd, 30C, down.txt','r')
lines22 = F22.readlines()
F22.close()

F23 = open('/Users/main/Desktop/Semesterarbeit/20.03/5%/5%, 70%, 750nm, 2nd, 45C, down.txt','r')
lines23 = F23.readlines()
F23.close()

F24 = open('/Users/main/Desktop/Semesterarbeit/20.03/5%/5%, 70%, 750nm, 2nd, 60C, down.txt','r')
...
plt.plot(data[:150,0,0],data[:150,1,0]/data[30,1,0],label='15C')
plt.plot(data[:150,0,1],data[:150,1,1]/data[30,1,1],label='30C')
plt.plot(data[:150,0,2],data[:150,1,2]/data[30,1,2],label='45C')
plt.plot(data[:150,0,3],data[:150,1,3]/data[30,1,3],label='60C')
plt.grid()
plt.xlabel('Wavelength')
plt.ylabel('Counts %')
...
data[323,1,9] = -3
plt.plot(data[300:,0,8],data[300:,1,8]/data[30,1,8],label='15C')
plt.plot(data[300:,0,9],data[300:,1,9]/data[30,1,9],label='30C')
plt.plot(data[300:,0,10],data[300:,1,10]/data[30,1,10],label='45C')
plt.plot(data[300:,0,11],data[300:,1,11]/data[30,1,11],label='60C')
plt.grid()
plt.xlabel('Wavelength')
plt.ylabel('Counts %')
...
plt.plot(data[:,0,8],data[:,1,8],label='15C')
plt.plot(data[:,0,9],data[:,1,9],label='30C')
plt.plot(data[:,0,10],data[:,1,10],label='45C')
plt.plot(data[:,0,11],data[:,1,11],label='60C')
plt.grid()
plt.xlabel('Wavelength')
plt.ylabel('Counts %')
...
"""
plt.plot(data[:150,0,16],data[:150,1,16]/data[30,1,16],label='15C')
plt.plot(data[:150,0,17],data[:150,1,17]/data[30,1,17],label='30C')
plt.plot(data[:150,0,18],data[:150,1,18]/data[30,1,18],label='45C')
plt.plot(data[:150,0,19],data[:150,1,19]/data[30,1,19],label='60C')
plt.grid()
plt.xlabel('Wavelength')
plt.ylabel('Counts %')
...
max11 = np.array([np.max(data11[:50]),np.max(data12[:50]),np.max(data13[:50]),np.max(data14[:50])])/np.max(data11[:50])
max12 = np.array([np.max(data21[50:]),np.max(data22[50:]),np.max(data23[50:]),np.max(data24[50:])])/np.max(data21[50:])
max21 = np.array([np.max(data31[:50]),np.max(data32[:50]),np.max(data33[:50]),np.max(data34[:50])])/np.max(data31[:50])
max22 = np.array([np.max(data41[50:]),np.max(data42[50:]),np.max(data43[50:]),np.max(data44[50:])])/np.max(data41[50:])
max31 = np.array([np.max(data51[:50]),np.max(data52[:50]),np.max(data53[:50]),np.max(data54[:50])])/np.max(data51[:50])
max32 = np.array([np.max(data61[50:]),np.max(data62[50:]),np.max(data63[50:]),np.max(data64[50:])])/np.max(data61[50:])
